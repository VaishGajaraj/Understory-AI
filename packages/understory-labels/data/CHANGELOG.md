...
- Added empty scaffolds for `amazon-para-imazon.geojson`, `eastern-woodland-controlled.geojson`, and `amazon-mining.geojson` (placeholders only — no claimed events until transcription under CONTRIBUTING.md).
